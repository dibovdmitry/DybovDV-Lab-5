...
19. Выполнен позитивный тест работы эндпоинтов POST /predict/emotion и POST /predict/emotion/batch, результаты показывают, что эндпоинты работают корректно; \
...
20. Проведено тестирование работы запросов с ошибками, а именно были выполнены: запрос с пустым текстом, со строкой длиной более тысячи символов и ошибкой в структуре JSON запроса; \
...
21. Проведён тест эндпоинта информации о модели, получены Status Code равный 200, версия модели, статус «loaded» и тип модели;
...
22. Выполнены запросы через curl. Создан файл api_test_report.md и записана информация;
![скриншот](report/Screenshot44.png "Эндпоинт информации о модели") \
Рисунок 41 - Эндпоинт информации о модели \
![скриншот](report/Screenshot45.png "Вывод информации о модели") \
Рисунок 42 - Вывод информации о модели
