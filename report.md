...
![скриншот](report/Screenshot15.png "Результат в командной строке") \
Рисунок 14 - Комментирование блока \
![скриншот](report/Screenshot16.png "Результат в сохранённом файле") \
Рисунок 15 - Наполнение Dockerfile
...
![скриншот](report/Screenshot17.png "Установка Apache Jena Fuseki") \
